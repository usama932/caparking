        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              ...
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">{{trans('admin.add')}} {{trans('admin.role')}}</a>
              </li>
            </ul>
            <!--end::Breadcrumb-->
          </div>
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">{{trans('admin.role')}} {{trans('admin.add')}} {{trans('admin.form')}}
                <i class="mr-2"></i>
          ...
          <!--begin::Form-->
            {{ Form::open([ 'route' => 'roles.store','class'=>'form' ,"id"=>"role_add_form", 'enctype'=>'multipart/form-data']) }}
              ...
              <div class="row">
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    <h3 class="text-dark font-weight-bold mb-10">{{trans('admin.role')}} {{trans('admin.info')}}: </h3>
