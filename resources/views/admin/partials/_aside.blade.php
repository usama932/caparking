    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper" style="background-color:#004dff !important";>
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav" >
                ...
                @endcan
                @if(auth()->user()->is_admin == 1 && auth()->user()->user_type == 'admin')
                ...
                @can('staff')
                    <li class="menu-item  <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'clients') {
                        ...
                        <a href="{{ route('clients.index') }}" class="menu-link">
                            ...
                            <span class="menu-text text-white">Staff</span>
                ...
                @endcan
                @can('rates')
                <li class="menu-item  <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'rates') {
                    echo 'menu-item-active';
                    } ?>" aria-haspopup="true">
                    <a href="{{ route('rates.index') }}" class="menu-link">
                        ...
                        <span class="menu-text text-white">Rates</span>
