          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">{{trans('admin.manage')}} {{trans('admin.plans')}}</a>
              </li>
              <li class="breadcrumb-item text-muted">
                {{trans('admin.edit')}} {{trans('admin.plans')}}
              </li>
              <li class="breadcrumb-item text-muted">
               {{ $plan->contract_person }}
              </li>
            </ul>
            <!--end::Breadcrumb-->
          </div>
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">{{trans('admin.plans')}}  {{trans('admin.edit')}} {{trans('admin.form')}}
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
                ...
                <div class="btn-group">
                    <a href=""  onclick="event.preventDefault(); document.getElementById('plan_update_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::model($plan, [ 'method' => 'PATCH','route' => ['plans.update', $plan->id],'class'=>'form' ,"id"=>"plan_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        <input type="hidden" name="pin" value="{{$plan->plan_id}}">
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid','id'=>'name','placeholder'=>'Enter Name','required'=>'true']) }}
                        <span class="text-danger">{{ $errors->first('name') }}</span>
                      </div>
                    </div>
                    <div class="form-group row {{ $errors->has('sub_name') ? 'has-error' : '' }}">
                      <label class="col-3">Monthly Subscription Name</label>
                      <div class="col-9">
