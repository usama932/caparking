        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Plan Add Form
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href="{{ route('plans.store') }}"  onclick="event.preventDefault(); document.getElementById('plan_add_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
