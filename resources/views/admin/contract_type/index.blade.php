    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Button-->
                <a href="{{ route('contact_types.create') }}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form action="{{ route('admin.delete-selected-contacttype') }}" method="post" id="contract_form">
...
@section('scripts')
    ...
    <script>
        ...
        var clients = $('#contracttypes').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": "{{ route('admin.getContactTypes') }}",
                "dataType": "json",
                "type": "POST",
                "data": {
        ...
        function viewInfo(id) {
            ...
            $.post("{{ route('admin.getContactType') }}", {
                _token: CSRF_TOKEN,
                id: id
        ...
        function del(id) {
            Swal.fire({
                ...
                if (result.value) {
                    Swal.fire(
                        "Deleted!",
                        "Your Contract Type has been deleted.",
                        "success"
                    );
                    var APP_URL = {!! json_encode(url('/')) !!}
                    window.location.href = APP_URL + "/admin/contacttype/delete/" + id;
                }
            });
        }
