        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">{{trans('admin.contract')}} {{trans('admin.type')}} {{trans('admin.edit')}} {{trans('admin.form')}}
                <i class="mr-2"></i>
          ...
          <!--begin::Form-->
            {{ Form::model($contract, [ 'method' => 'PATCH','route' => ['contact_types.update', $contract->id],'class'=>'form' ,"id"=>"contract_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                      <label class="col-3">{{trans('admin.title')}}</label>
                      <div class="col-9">
