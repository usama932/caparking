        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              ...
              <li class="breadcrumb-item text-muted">
                {{trans('admin.edit')}} {{trans('admin.contract')}}
              </li>
              <li class="breadcrumb-item text-muted">
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">{{trans('admin.contract')}}  {{trans('admin.edit')}} {{trans('admin.form')}}
                <i class="mr-2"></i>
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    @if(auth()->user()->user_type == "company")
                      @if(auth()->user()->order->plan_name == 'Premium')
                        <div class="form-group row {{ $errors->has('users') ? 'has-error' : '' }}">
                          ...
                          <div class="col-9">
                            <select name="users" id="select2Multiple" class="select2-multiple select-2 form-control form-control-solid">
                    ...
                    <div class="form-group row {{ $errors->has('address') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                     <textarea rows="2" cols="50" class = "form-control form-control-solid" name="address" placeholder="Enter Address here...">{{ $contract->address ?? 'Enter Address' }}</textarea><span class="text-danger">{{ $errors->first('address') }}</span>
                      </div>
                    </div>
                    ...
                    <div class="form-group row {{ $errors->has('file') ? 'has-error' : '' }}">
                      <label class="col-3">{{trans('admin.contract')}}  {{trans('admin.file')}} </label>
                      <div class="col-9">
